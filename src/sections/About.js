...
import img3 from '../assets/Images/pic3.jpeg'
...
const About = () => {
    return (
        <Section id="fixed-target">
            ...
            <Left data-scroll data-scroll-speed data-scroll-target="#fixed-target">
                We're fashion store based in Firozabad. 
                We sell unique designs that will blow your mind. 
                Fashion is an ART that can not be grasped by everyone.
                <br/>
                <br/>

                We are very dedicated to selling our products. 
